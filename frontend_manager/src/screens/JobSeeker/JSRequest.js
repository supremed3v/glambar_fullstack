...
const Request = ({ navigation }) => {
    const onRecruitedPressed = () => {
        navigation.navigate("Recruited");
    };
        ...
        <View>
            <View style={styles.container_center}>
                ...
                <View style={{ flexDirection: "row", paddingHorizontal: 20, }}>
                    <TouchableOpacity onPress={onRecruitedPressed}>
                        <AppointmentSelectorButton title="Recruited" backgroundColor='rgb(162, 188, 237)' style={styles.borderLeft} />
                    </TouchableOpacity>

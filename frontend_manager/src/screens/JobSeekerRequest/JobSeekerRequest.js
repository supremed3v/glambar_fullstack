...
const JobSeekerRequest = ({ navigation }) => {
  const onSelectedPressed = () => {
      navigation.navigate("JobSeekerRecruited");
  };
  ...
  return (
      <View>
          <View style={styles.container_center}>
              <Text style={styles.AppointmentText}>Job Applicants</Text>
              <View style={{ flexDirection: "row", paddingHorizontal: 20, }}>
                  <TouchableOpacity onPress={onSelectedPressed}>
                      <AppointmentSelectorButton title="Selected" backgroundColor='rgb(162, 188, 237)' style={styles.borderLeft} />
                  </TouchableOpacity>

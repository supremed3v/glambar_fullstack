    ...
    <View>
      <View style={styles.container_center}>
        ...
        <View style={{ flexDirection: "row", paddingHorizontal: 20, }}>
          <AppointmentSelectorButton title="Upcoming" backgroundColor='rgb(80, 133, 225)' style={styles.borderLeft} />
          <TouchableOpacity onPress={onPassedPressed}>
            <AppointmentSelectorButton title="Passed" backgroundColor='rgb(162, 188, 237)' style={styles.borderRight} />
          </TouchableOpacity>
        </View>
      </View>
      <ScrollView>
